        ...
        <div className="topbar">
          <div style={{ display:'flex', alignItems:'center', gap:12 }}>
            <button 
              ...
              className="md:hidden"
              style={{ background:'none', border:'none', cursor:'pointer', color:'var(--text-2)', display:'flex', alignItems:'center' }}
            >
              <Menu size={20} />
            </button>
          ...
          <span className="topbar-kbd-info" style={{ fontSize:11.5, color:'var(--text-4)' }}>
